...
class C_ReturnParameterTest extends WordSpec with Matchers {
  ...
  "typeDecl" in {
    cpg.typeDecl.l.size shouldBe 3
  ...
  "method AST" in {
    ...
    */
    ...
    block.start.astChildren.l.size shouldBe 6
